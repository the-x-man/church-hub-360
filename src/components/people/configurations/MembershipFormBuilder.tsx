...
export function MembershipFormBuilder({
  ...
  const updateComponentDirect = (rowId: string, columnId: string, updatedComponent: FormComponent) => {
    const updatedSchema = {
      ...formSchema,
      rows: formSchema.rows.map((row) =>
        row.id === rowId
                ...
                col.id === columnId && col.component
                  ? {
                      ...
                      component: {
                        ...
                        options: ['select', 'radio', 'checkbox'].includes(newType) 
        ...
        <Card className="min-h-[300px]">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Choose column layouts and add components to build your membership
              form
            </p>
          </CardHeader>
                        ...
                        <div key={column.id} className="space-y-3">
                          <FormColumn
                            ...
                            onComponentChange={(updatedComponent) =>
                              updateComponentDirect(row.id, column.id, updatedComponent)
                            }
                            onComponentSelect={(componentType) =>
                              addComponentToColumn(row.id, column.id, componentType)
                            }
